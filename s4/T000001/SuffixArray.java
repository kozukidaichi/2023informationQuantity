...
public class SuffixArray {
    private static void induced_sort(int[] vec, int vec_size, int val_range, int[] sa, int sa_size, boolean[] sl,
            int[] lms_idx, int lms_idx_offset, int lms_idx_size) {
    ...
    public static void main(String[] args) {
        ...
        Debug.printSuffixArray(sa, text, n);
    }
}